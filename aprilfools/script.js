document.addEventListener('DOMContentLoaded', function() {
    ...
    // Create rarity display element if it doesn't exist
    let rarityDisplay = document.getElementById('rarity-display');
    if (!rarityDisplay) {
        rarityDisplay = document.createElement('div');
        rarityDisplay.id = 'rarity-display';
        // Insert after the selected aura name
        selectedAuraName.parentNode.insertBefore(rarityDisplay, selectedAuraName.nextSibling);
    }
